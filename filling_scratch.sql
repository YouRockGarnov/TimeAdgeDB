...
INSERT INTO Idea VALUES(1, "КР по алгему", "Хорошая тема прорешать прошлый год", "2018-01-17 10:00:00", 1);
INSERT INTO Idea VALUES(2, "Зачет по бд", "А что если не прийти?", "2018-05-19 10:00:00", 1);
INSERT INTO Idea VALUES(3, "Собес в Яндекс", "А что если не прийти?", "2018-05-17 12:00:00", 2);
INSERT INTO Idea VALUES(4, "КР по матану", "А что если не прийти?", "2018-04-17 10:00:00", 2);
INSERT INTO Idea VALUES(5, "КР по матану", "Надо взять у Жени тетрадь и сдать как свою", "2017-05-17 10:00:00", 1);
INSERT INTO Idea VALUES(6, "КР по алгему", "Хорошая тема прорешать прошлый год", "2018-05-17 10:54:00", 2);

INSERT INTO TaskList VALUES (1, "ProgaTasks", NULL);

INSERT INTO Category VALUES (1, 'Programing', "true_programers.png");
INSERT INTO Category VALUES (2, 'Chill', "relax.png");
...
INSERT INTO Place VALUES (1, 'Second dormatory', NULL, '123.123');
INSERT INTO Place VALUES (2, 'First dormatory', NULL, '121.123');
...
INSERT INTO Tracking VALUES (4, "lol", 2, "2018-03-19 10:00:00", "2018-03-19 11:00:00", 2, 1, NULL);
